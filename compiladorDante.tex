...
(define-peg number
            ...
            (string-\textgreater number value))
...
1) Ela tenta ser familiar com pessoas que já utilizaram LISP utilizando comandos familiares e até o mesmo comando para compilação.

2) Ela é de fácil instalação, vindo com IDE inclusa.

3) É uma linguagem livre e por isso facilmente modificavel.

4) Tem amplo suporte dos Desenvolvedores e do site que é bem estruturado.

5) Ótima para desenvolvimento de outras linguagens e compiladores por ter um PARSE embutido e muitos outros motivos.
